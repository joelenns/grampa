...
//let height10 element2.getComputedStyle().transform-origin;
  ...
  // todo: find first ul class="sidenav" li 'a class="active"'
  //  display text (Home) n switch (internet infrastructure-world)
  //  host server's index name requirement to that user-world name
  bmarkname2 = bmarkname3.replace("index", "home");
  bookmarkname = bmarkname2 + "_" +
    checkTime(localStorage.length + 1) + "_" +
    stampdate();
  storeBookmark (bookmarkname, y.toFixed()); 

//element2.scrollIntoView is not a function
...
"height1 (DOM document.defaultView) view.innerHeight = " + height + "<br>" +
"height2 (includes browser bars) view.outerHeight = " + height2 + "<br>" +
"height3 (DOM window) myWindow.innerHeight = " + height3 + "<br>" +
...
"height8 (DOM body, or...) element2.offsetTop = " + height8 + "<br>" +
